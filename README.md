...
<head>
    ...
    <title>BabyTri Land - Apprends à trier en t'amusant !</title>
    <meta name="description" content="Jeu éducatif pour enfants de 3 à 6 ans. Apprends à trier les déchets, débloque 12 badges impressionnants et 4 personnages magiques !">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div id="welcome-screen" class="welcome-screen">
            <div class="welcome-card">
                ...
                <p class="welcome-subtitle">Apprends à trier en t'amusant ! 🎮</p>
                ...
                <div class="input-group">
                    <label class="input-label">👋 Comment tu t'appelles ?</label>
                    <input type="text" id="player-name" class="name-input" placeholder="Ton prénom" maxlength="20">
                </div>

                <button class="btn btn-primary" id="start-btn" disabled>Commencer ! 🚀</button>
                <button class="btn btn-secondary" id="tutorial-btn">Comment jouer ? 📚</button>
            </div>
        </div>
            ...
            <div class="tutorial-card">
                ...
                <div class="tutorial-step">
                    ...
                    <div class="tutorial-content">
                        <h3>1. Attrape un déchet</h3>
                        <p>Clique et maintiens sur un déchet pour le prendre</p>
                    </div>
                </div>
                ...
                <div class="tutorial-step">
                    ...
                    <div class="tutorial-content">
                        ...
                        <p>
                            🍂 Marron = Organique (fruits, légumes)<br>
                            ♻️ Jaune = Plastique (bouteilles, sacs)<br>
                            ⚗️ Vert = Verre (bocaux, bouteilles)<br>
                            📄 Bleu = Papier (journaux, cartons)
                        </p>
                    </div>
                </div>
                ...
                <div class="tutorial-step">
                    <span class="tutorial-emoji">🎖️</span>
                    <div class="tutorial-content">
                        <h3>4. Débloque des badges</h3>
                        <p>12 badges super impressionnants à collectionner !</p>
                    </div>
                </div>
                ...
                <div class="tutorial-step">
                    <span class="tutorial-emoji">✨</span>
                    <div class="tutorial-content">
                        <h3>5. Débloque des personnages</h3>
                        <p>À 3, 6, 9 et 12 points, tu gagneras un ami magique !</p>
                    </div>
                </div>

                <button class="btn btn-primary" id="back-to-welcome-btn">J'ai compris ! 🎮</button>
            </div>
        </div>
        ...
        <div class="badges-modal" id="badges-modal">
            <div class="badges-modal-content">
                <button class="close-btn" id="close-badges-modal">×</button>
                
                <div class="badges-modal-header">
                    <div class="badges-modal-emoji">🎖️</div>
                    <h2 class="badges-modal-title">Mes Badges</h2>
                    <p class="badges-modal-subtitle"><span id="badges-count">0</span>/12 débloqués</p>
                </div>

                <div class="badges-grid" id="badges-grid"></div>

                <div class="badges-encouragement">
                    <p>⭐ Continue à trier pour débloquer tous les badges ! ⭐</p>
                </div>
            </div>
        </div>
        ...
        <div class="modal" id="character-modal">
            <div class="modal-content">
                <h2 class="modal-title">🎉 Bravo <span id="modal-player-name"></span> ! 🎉</h2>
                ...
                <div class="modal-congrats">
                    ✨ Tu as maintenant un nouveau compagnon magique ! ✨
                </div>
                <button class="btn btn-primary" id="close-modal-btn">Continuer à jouer ! 🎮</button>
            </div>
        </div>
        ...
        <div id="victory-screen" class="victory-screen hidden">
            <div class="victory-card">
                ...
                <h2 class="victory-title">Félicitations <span id="victory-player-name"></span> ! </h2>
                <p class="victory-message">Tu as trié tous les déchets !</p>
                <p class="victory-score">Score final : <span id="final-score">0</span> points ⭐</p>

                <div class="victory-section" id="victory-badges-section" style="display: none;">
                    <h3 class="victory-section-title">🎖️ Tes badges débloqués</h3>
                ...
                <div class="victory-section" id="victory-characters-section" style="display: none;">
                    <h3 class="victory-section-title">✨ Tes personnages magiques</h3>
                    <div class="victory-characters-grid" id="victory-characters-grid"></div>
                </div>

                <div class="victory-message-box">
                    <p>🌍 Bravo ! Tu es maintenant un expert du tri ! 🌟</p>
                    <p style="font-size: 1em; margin-top: 10px;">Continue à trier dans la vraie vie pour protéger notre planète !</p>
                </div>
        ...
        <div id="game-area" class="hidden">
            ...
            <header class="header">
                ...
                <div class="progress-section">
                    <div class="progress-label">
                        <span id="progress-label">✨ Prochain personnage</span>
            ...
            <section class="section">
                <h2 class="section-title">🗑️ Poubelles de tri</h2>
            ...
            <!-- Waste Items Section -->
            <section class="section">
                <h2 class="section-title">🎯 Déchets à trier <span id="waste-count">(12)</span></h2>
                <div class="waste-grid" id="waste-container"></div>
            </section>

            <!-- Characters Section -->
            <section class="section">
                <h2 class="section-title">✨ Mes personnages magiques <span id="character-count">(0/4)</span></h2>
    ...
    <script>
        // Données du jeu
        const wasteItems = [
            { id: '1', name: 'Banane', emoji: '🍌', correctBin: 'organic' },
            { id: '2', name: 'Pomme', emoji: '🍎', correctBin: 'organic' },
            { id: '3', name: 'Carotte', emoji: '🥕', correctBin: 'organic' },
            { id: '4', name: 'Bouteille', emoji: '🧴', correctBin: 'plastic' },
            { id: '5', name: 'Sac', emoji: '🛍️', correctBin: 'plastic' },
            { id: '6', name: 'Jouet', emoji: '🦆', correctBin: 'plastic' },
            { id: '7', name: 'Pot verre', emoji: '🫙', correctBin: 'glass' },
            { id: '8', name: 'Bouteille', emoji: '🍷', correctBin: 'glass' },
            { id: '9', name: 'Bocal', emoji: '⚗️', correctBin: 'glass' },
            { id: '10', name: 'Journal', emoji: '📰', correctBin: 'paper' },
            { id: '11', name: 'Carton', emoji: '📦', correctBin: 'paper' },
            { id: '12', name: 'Livre', emoji: '📚', correctBin: 'paper' }
        ];
        ...
        const characters = [
            { 
                ...
                name: 'Recyclor', 
                emoji: '🤖', 
                power: 'Le robot écolo',
                description: 'Recyclor transforme les déchets en objets magiques !',
                unlockScore: 3,
                image: 'https://img.sanishtech.com/u/61b4cfe960605813dcdb9c88a00d0127.png'
            },
            { 
                id: 'verdina', 
                name: 'Verdina', 
                emoji: '🧚', 
                power: 'La fée de la nature',
                description: 'Verdina fait pousser des fleurs partout où elle passe !',
                unlockScore: 6,
                image: 'https://img.sanishtech.com/u/fc520aa9810662edcf9ec3470d80038d.png'
            },
            { 
                id: 'captain', 
                name: 'Captain Tri', 
                emoji: '🦸', 
                power: 'Le super-héros',
                description: 'Captain Tri protège la planète avec ses super pouvoirs !',
                unlockScore: 9,
                image: 'https://img.sanishtech.com/u/42b26589addceb5e46d526130b52b82e.png'
            },
            { 
                id: 'ecolo', 
                name: 'Ecolo', 
                ...
                description: 'Ecolo garde notre belle planète propre et verte !',
                unlockScore: 12,
                image: 'https://img.sanishtech.com/u/ec8b6db8f96c017ec48cb882ad8d2b61.png'
            }
        ];

        const badges = [
            { id: 'first-star', name: 'Première Étoile', emoji: '⭐', description: 'Ton premier tri réussi !', requirement: 1, color: 'yellow' },
            { id: 'beginner', name: 'Débutant Super', emoji: '🌟', description: 'Tu commences bien !', requirement: 2, color: 'peach' },
            { id: 'tri-genius', name: 'Génie du Tri', emoji: '🧠', description: 'Tu es trop fort !', requirement: 4, color: 'pink' },
            { id: 'eco-hero', name: 'Héros Écolo', emoji: '🦸', description: 'Tu protèges la planète !', requirement: 5, color: 'mint' },
            { id: 'recycle-king', name: 'Roi du Recyclage', emoji: '👑', description: 'Tu es le roi du tri !', requirement: 7, color: 'lavender' },
            { id: 'rainbow', name: 'Arc-en-Ciel', emoji: '🌈', description: 'Toutes les couleurs du tri !', requirement: 8, color: 'aqua' },
            { id: 'master', name: 'Grand Maître', emoji: '🎓', description: 'Tu maîtrises tout !', requirement: 9, color: 'blue' },
            { id: 'magician', name: 'Grand Magicien', emoji: '🪄', description: 'Tu fais de la magie !', requirement: 10, color: 'pink' },
            { id: 'champion', name: 'Champion Ultime', emoji: '🏆', description: 'Tu es le meilleur !', requirement: 11, color: 'yellow' },
            { id: 'legend', name: 'Légende Cosmique', emoji: '💫', description: 'Tu es une légende !', requirement: 12, color: 'lavender' },
            { id: 'planet-saver', name: 'Sauveur Planétaire', emoji: '🌍', description: 'Tu sauves la Terre !', requirement: 12, color: 'mint' },
            { id: 'ultimate', name: 'Trieur Suprême', emoji: '✨', description: 'PERFECTION ABSOLUE !', requirement: 12, color: 'aqua' }
        ];
        ...
        function renderCharacters() {
            ...
            characters.forEach(character => {
                ...
                div.innerHTML = `
                    ...
                    ` : `
                        <div class="unlock-requirement">Débloque à ${character.unlockScore} points</div>
                    `}
                `;
        ...
        function handleDrop(e) {
            ...
            if (draggedItem.correctBin === binType) {
                ...
                showFeedback('Bravo ! +1 point 🎉', 'success');
                updateScore();
                updateProgress();
                checkBadges();
                ...
                showFeedback('Oops ! Mauvaise poubelle 😅', 'error');
            }
        ...
        function updateProgress() {
            ...
            if (nextCharacter) {
                ...
                document.getElementById('progress-label').textContent = `✨ Prochain personnage: ${nextCharacter.name}`;
                document.getElementById('progress-text').textContent = `${score}/${nextCharacter.unlockScore}`;
                document.getElementById('progress-fill').style.width = `${Math.min(progress, 100)}%`;
            } else {
                document.getElementById('progress-label').textContent = '✨ Tous les personnages débloqués !';
